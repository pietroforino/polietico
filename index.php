  ...
  <!-- end php -->
    ...
    <div id="controller">
      ...
      <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
      	 viewBox="0 0 155 155" style="enable-background:new 0 0 155 155;" xml:space="preserve" src="assets/erase.svg" id="eraseButton" onclick="cambiaColore('gomma', '#ffffff')" ontouchstart="window.open('gomma', '#ffffff')" style="cursor:pointer">
